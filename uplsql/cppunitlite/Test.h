...
MOCK_METHOD( AnsiString __fastcall GetInfoFromDB(AnsiString SQL_Text, AnsiString Params))

#define TEST_MOCK1(name,classUnderTest, p1)\
	class classUnderTest##name##Test : public Test, classUnderTest \
	{ \
		public: \
			classUnderTest##name##Test () : Test (#name "Test"), classUnderTest(p1) {} \
            void setup() {}; \
            void teardown() {}; \
