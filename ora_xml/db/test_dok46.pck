...
nz number := null;
begin
  x := m_Dok46(null,null,null,null);
  x.rec_zag := m_T_ZagDok(null);
  x.rec_sod := m_T_SodDok(null);
  x.createdok46(nz, 'М', XMLtype('<DOC><SOD><ROW><KOD_MAT>qwe</KOD_MAT><KOL_TREB>111</KOL_TREB></ROW><ROW><KOD_MAT>rty</KOD_MAT><KOL_TREB>222</KOL_TREB></ROW></SOD></DOC>'));
...
begin
  ...
  x.rec_zag := m_T_ZagDok(null);
  x.rec_sod := m_T_SodDok(null);
  x.createdok46(nz, 'М', XMLtype('<DOC><ZAG><ROW><OP>33</OP><CEH_POST>11.11</CEH_POST><CEH_POTR>22.22</CEH_POTR></ROW></ZAG><SOD></SOD></DOC>'));
