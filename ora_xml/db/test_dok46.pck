...
begin
  ...
  x.createdok(nz, 'М', XMLtype('<DOC><SOD><ROW><KOD_MAT>qwe</KOD_MAT><DOP_KOD>dop_kod</DOP_KOD><NZ_CEH>5678</NZ_CEH><NZ_PRIH>1234</NZ_PRIH><D_GAR>11.11.2014</D_GAR><DCE>dce</DCE><PRIM>prim</PRIM><SHPZ>shpz</SHPZ><IZD>izd</IZD><KOL_TREB>111</KOL_TREB></ROW><ROW><KOD_MAT>rty</KOD_MAT><KOL_TREB>222</KOL_TREB></ROW></SOD></DOC>'));
  ...
  chk(x.rec_sod.rec(1).nz_ceh is null);
...
begin
  ...
  x.rec_zag := m_T_ZagDok(null);
  x.rec_sod := m_T_SodDok(null);
  x.createdok(nz, 'М', XMLtype('<DOC><ZAG><ROW><PRIM>prim</PRIM><OP>33</OP><CEH_POST>11.11</CEH_POST><CEH_POTR>22.22</CEH_POTR></ROW></ZAG><SOD></SOD></DOC>'));
